void main() {
  ...
  final String nomComplet = "Ndongo fall Ndiaye";
  ...
  List<String> liste = ["lemon", "banane", "orange", "pomme"];
  ...
  // Validation d'emails
  String email1 = "pape@example.com";
  String email2 = "dio.email@.com";
  String email3 = "km7.@email.com";
